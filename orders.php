...
<table width="100%" align="center" border="2">
	...
	<tr>
		<td colspan="10" align="center"><strong><h3>View Orders</h3></strong></td>
	  </tr>
		...
		<?php
		$qry=mysqli_query($conn,"select * from addcart where reg='$reg' && (status='1'|| status='2')");
		$i=1;
		   ...
		   <td><div align="center"><?php echo $row1['mname'];?></div></td>
			 ...
			 <td><div align="center"><?php echo $row['quantity'];?></div></td>
			   <td><div align="center"><?php echo $row['amount'];?></div></td>		 
			    <td><div align="center"><a href="feedback.php?id=<?php echo $row1['id']; ?>&mname=<?php echo $row1['mname'];?>">Give Feedback</a></div></td>		 
        </tr>

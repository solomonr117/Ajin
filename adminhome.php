...
<tr>
		<td colspan="13" align="center"><strong><h3>All Users  Details</h3></strong></td>
  </tr>
		   ...
		   <td ><div align="center" class="style6"><strong> Name</strong> </div></td>
		    ...
		    <td ><div align="center" class="style6"><strong>Email</strong> </div></td>
			 <td ><div align="center" class="style6"><strong>Phone</strong> </div></td>
			  ...
			  <td  ><div align="center" class="style6"><strong>User Name</strong> </div></td>
        ...
        <tr>
		    ...
		    <td><div align="center"><?php echo $row['name'];?></div></td>
			 ...
			 <th scope="col" align="center"><a href="deleteu.php?id=<?php echo $row['id'];?>">Delete</a></th>

...
$qry=mysqli_query($conn,"select * from user where uname='$uname' && psw='$password'");
...
$qry=mysqli_query($conn,"select * from manager where uname='$uname' && psw='$password'");
$num=mysqli_num_rows($qry);
if($num==1)
{
echo "<script>alert('welcome to manager login')</script>";
header("location:mhome.php");
}

}elseif($type=='employee'){

$qry=mysqli_query($conn,"select * from emp where uname='$uname' && psw='$password'");
$num=mysqli_num_rows($qry);
if($num==1)
{
echo "<script>alert('welcome to employee login')</script>";
...
<form id="form1" name="form1" method="post" action="">
	   <table width="48%" border="0" align="center">
         <tr>
           <td colspan="2" rowspan="1"><div align="center" class="style1"><strong><font size="+1">Login</font> </div></td>
		 </tr>
			<tr>
		 <td height="31"align="center"><span class="style2"><strong>Select Type </strong></span></td>
		    <td ><select name="type" =>
  <option value="admin">User Management</option>

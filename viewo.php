...
<table width="94%" align="center" border="3">
	
	
	<tr>
		<td colspan="10" align="center"><strong><h3>Ordered Details</h3></strong></td>
  </tr>
	...
	<tr>
		<td colspan="10">&nbsp;</td>
		  ...
		  <td width="11%"><div align="center" class="style6"><strong>Product Image</strong> </div></td>
		   <td width="10%"><div align="center" class="style6"><strong>Product Name</strong> </div></td>
		   		   <td width="10%"><div align="center" class="style6"><strong>Product Id</strong> </div></td>
		   <td width="7%"><div align="center" class="style6"><strong>Price</strong> </div></td>
		    <td width="9%"><div align="center" class="style6"><strong>Quantity</strong> </div></td>
			<td width="9%"><div align="center" class="style6"><strong>Amount</strong> </div></td>
			<td width="12%"><div align="center" class="style6"><strong>User Name</strong> </div></td>
			<td width="11%"><div align="center" class="style6"><strong>Contact No</strong> </div></td>
			<td width="12%"><div align="center" class="style6"><strong>Address</strong> </div></td>
			<td width="11%"><div align="center" class="style6"><strong>Action</strong> </div></td>
        </tr>
		<tr>
		<td colspan="10">&nbsp;</td>
		</tr>
        ...
        <tr>
		   ...
		   <td><div align="center"><?php echo $row1['mname'];?></div></td>
		      <td><div align="center"><?php echo $row['bid'];?></div></td>
			 ...
			 <td><div align="center"><?php echo $row['quantity'];?></div></td>
			   ...
			   <td><div align="center"><?php echo $row2['address'];?></div></td>
			    <td><div align="center"><a href="delivery.php?oid=<?php echo $row['id'];?>&quan=<?php echo $row['quantity'];?>&bid=<?php echo $row['bid'];?>">Delivery</a></div></td>		 
        </tr>

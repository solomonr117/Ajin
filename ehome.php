...
<form id="f1" name="f1" method="post" action="#"   enctype="multipart/form-data">
  <table width="38%" height="372" border="0" align="center">	
    ...
    <tr>
     ...
     <td colspan="2"  align="center" ><div class="style5"><h3>Add Product Details</h></div></td>
    ...
    <tr>
      ...
      <td width="57%"><label>
        <input name="brname" type="text" id="name" required/>
      </label></td>
	...
	<tr>
	 ...
	 <tr>
      ...
      <td height="49">Model Name</td>
      <td><input name="mname" type="text" id="price" required/></td>
     
    </tr>
	 <tr>
      
      <td height="49">Screen Size</td>
      <td><input name="weight" type="text" id="price" required/></td>
     
    </tr>
	 <tr>
      
      <td height="49">RAM</td>
      <td><input name="ram" type="text" id="price" required/></td>
     
    </tr>
	 <tr>
      
      <td height="49">Storage</td>
      <td><input name="storage" type="text" id="price" required/></td>
	 ...
	 <tr>
      ...
      <td height="47">Product Image</td>
      <td><input name="upload" type="file" id="file" required/></td>
